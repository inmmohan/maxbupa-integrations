...
public class MongoDBConstant {
    ...
    public static final String ONLINE_LEADS = "onlineLeads";
    public static final String FORMS_QUOTE_ID = "forms.quoteId";
    public static final String FORMS_GET_QUOTE_PRODUCT_ID = "forms.getQuickQuoteForm.productId";
    public static final String PAYMENT_STATUS = "paymentStatus";
    public static final String PREMIUM_PRODUCT_ID = "premium.productId";
    public static final String PAYMENT_SUCCESS = "M001";
    ...
    public static final String JOURNEY_COMPLETE = "isJourneyComplete";
